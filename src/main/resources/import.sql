...
INSERT INTO users(id, name, email,password) VALUES (1,'nombre', 'email', 'password');
INSERT INTO users(id, name, email,password) VALUES (2,'nombre2', 'email2', 'password2');
INSERT INTO users(id, name, email,password) VALUES (3,'nombre3', 'email3', 'password3');